    ...
    return (
        <div>
            ...
            <div className='grid grid-cols-2'>
                <div className='p-8 px-16  h-screen bg-gray-200 pt-[12em]'>
                    ...
                    <div className='mt-8'>
                        {/* <Carousel> 
            <Testimonial imgsrc={Imgsrc} userName={"Julie Juz"} userComment={"Very useful Notion templates that inspired me to create my own following my needs. Thank you to give that to the world."} month={"April"} date={"12"} year={"2023"}/>
                ...
                <div>
                    ...
                    <div className='flex justify-center pt-8'>
                        <label>
                            ...
                            <input type='text' placeholder='Enter name' className='w-80 border  border-black outline-none text-[15px] px-2 py-2 font-semibold'></input>
                        </label>
                    </div>
                    <div className='flex justify-center pt-2'>
                        <label>
                            <p className='text-[12px] text-light opacity-70'>Rating</p>
                            <select placeholder='Select Rating' className='border w-80 border-black outline-none text-[15px] px-2 py-2 font-semibold'>
                    ...
                    <div className='flex justify-center pt-2'>
                        <label>
                            ...
                            <textarea type='text' placeholder='Drop a comment' className='w-80 border border-black outline-none text-[15px] px-2 py-2 font-semibold'></textarea>
                        </label>
                    </div>
