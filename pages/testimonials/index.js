        ...
        <div>
            ...
            {!open ? (
                <div>
                    ...
                    <select placeholder='Sort' className='border border-black rounded-md px-2 py-1 mt-20 text-left text-[xl]  font-semibold w-40 mr-10'>
                        <option>Sort</option>
                    ...
                    <div className='grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-4 px-8 pb-20'>
