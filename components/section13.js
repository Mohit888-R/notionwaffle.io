                ...
                <div className='grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-8 '>
                    <div className='bg-[#F1F0EE] rounded-lg drop-shadow-md'>
                        ...
                        <div className='px-8 pb-16'>
                            <a href='/simple-notin-templates' className='text-[24px] font-semibold'>Ultimate Life Planner</a>
                            ...
                            <a href='/premium-notin-templates' className='py-2 bg-white px-4 rounded-md text-[16px] font-semibold opacity-80'>Learn more</a>
                        </div>
                    </div>
                    <div className='bg-[#F1F0EE]  rounded-lg drop-shadow-md'>
                        <Image src={ultimateFinTracker} width={500} height={300} alt="" className='p-4' />
                        <div className='px-8 pb-16'>
                            <a href='/premium-notin-templates' className='text-[24px] font-semibold'>Ultimate Finance Tracker</a>
                    ...
                    <div className='bg-[#F1F0EE] rounded-lg drop-shadow-md'>
                        ...
                        <div className='px-8 pb-16'>
                            <a href='/simple-notin-templates' className='text-[24px] font-semibold'>Complete Bundle</a>
