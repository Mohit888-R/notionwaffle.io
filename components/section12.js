        ...
        <div className='m-auto justify-center flex my-16 px-16'>
            <div className='grid md:grid-cols-2 grid-cols-1 gap-8 '>
                <div className='bg-[#F1F0EE]  rounded-lg drop-shadow-md'>
                    <Image src={PremiumImage} width={500} height={300} alt="" className='p-4' />
                    <div className='px-8 pb-16'>
                        ...
                        <a href='/premium-notin-templates' className='py-2 bg-white px-4 rounded-md text-[16px] font-semibold opacity-80'>View premium templates</a>
                    </div>
                </div>
                <div className='bg-[#F1F0EE] rounded-lg drop-shadow-md'>
                    <Image src={SimpleImage} width={500} height={200} alt="" className='p-4' />
                    <div className='px-8 pb-16'>
