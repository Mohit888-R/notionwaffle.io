            ...
            <div className='grid md:grid-cols-2 grid-cols-1 gap-8 '>
                <div className='bg-[#F1F0EE]  rounded-lg drop-shadow-md'>
                    ...
                    <div className='px-8 pb-16'>
                        <a href='/premium-notion-templates' className='text-[30px] font-semibold'>Premium Notion templates</a>
                ...
                <div className='bg-[#F1F0EE] rounded-lg drop-shadow-md'>
                    ...
                    <div className='px-8 pb-16'>
                        <a href='/simple-notion-templates' className='text-[30px] font-semibold'>Simple Notion templates</a>
